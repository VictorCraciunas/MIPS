...
begin
  ...
  begin
    case s_counter_out(15 downto 13) is
      when "000"  => an <= b"1110"; -- Updated for 4 anodes
      when "001"  => an <= b"1101"; -- Updated for 4 anodes
      when "010"  => an <= b"1011"; -- Updated for 4 anodes
      when "011"  => an <= b"0111"; -- Updated for 4 anodes
